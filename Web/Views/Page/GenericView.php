...
class GenericView extends \phpOMS\Views\View
{
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    public function setRequest(\phpOMS\Message\Http\Request $request)
    {
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    public function getResponse() : \phpOMS\Message\Http\Response
    {
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    public function setResponse(\phpOMS\Message\Http\Response $response)
    {
