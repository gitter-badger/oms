...
class Application
{
    ...
    public function run($request, $response)
    {
        ...
        if ($account->getId() < 1) {
            ...
            $head->addAsset(\phpOMS\Asset\AssetType::JS, $baseUri . 'Web/Reporter/js/reporter.js');
        ...
        $this->app->moduleManager->loadLanguage($response->getL11n()->getLanguage(), 'reporter');

        $head->addAsset(\phpOMS\Asset\AssetType::CSS, $baseUri . 'Web/Reporter/css/reporter.css');
        $head->addAsset(\phpOMS\Asset\AssetType::CSS, $baseUri . 'External/fontawesome/css/font-awesome.min.css');
        $head->addAsset(\phpOMS\Asset\AssetType::JS, $baseUri . 'jsOMS/oms.min.js');
