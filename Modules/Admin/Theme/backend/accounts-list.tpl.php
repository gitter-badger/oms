 ...
 * UI Logic
 */
$accountListView = new \Web\Views\Lists\ListView($this->app, $this->request, $this->response);
 ...
 * Header
 */
$headerView->setTitle($this->l11n->lang['Admin']['Accounts']);
$headerView->setHeader([
    ...
    ['title' => $this->l11n->lang['Admin']['Activity'], 'sortable' => true],
    ['title' => $this->l11n->lang['Admin']['Created'], 'sortable' => true],
]);
