...
$panelCreate->setTitle($this->l11n->lang['Admin']['Group']);
...
$formGroupCreate = new \Web\Views\Form\FormView($this->app, $this->request, $this->response);
...
$formGroupCreate->setElement(1, 0, [
    'type'        => \phpOMS\Html\TagType::INPUT,
    'subtype'     => 'text',
    'label'       => $this->l11n->lang['Admin']['Name'],
    'name'        => 'gname',
    'placeholder' => $this->l11n->lang['Admin']['Group'],
]);

$formGroupCreate->setElement(2, 0, [
    'type'  => \phpOMS\Html\TagType::TEXTAREA,
    'label' => $this->l11n->lang['Admin']['Description'],
    'name'  => 'gdesc',
]);
