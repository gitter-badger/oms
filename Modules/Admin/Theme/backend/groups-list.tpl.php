 ...
 * UI Logic
 */
$groupListView = new \Web\Views\Lists\ListView($this->app, $this->request, $this->response);
 ...
 * Header
 */
$headerView->setTitle($this->l11n->lang['Admin']['Groups']);
$headerView->setHeader([
    ['title' => $this->l11n->lang[0]['ID'], 'sortable' => true],
    ['title' => $this->l11n->lang['Admin']['Name'], 'sortable' => true, 'full' => true],
    ['title' => $this->l11n->lang['Admin']['Parents'], 'sortable' => true],
    ['title' => $this->l11n->lang['Admin']['Children'], 'sortable' => true],
    ['title' => $this->l11n->lang['Admin']['Members'], 'sortable' => true],
]);
