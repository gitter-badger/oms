    ...
    <table class="t t-1 c27-1 c27" id="i27-1-1">
        ...
        <tr>
            <th colspan="10" class="lT">
                ...
                <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Shipping']; ?></h1>
            <th class="rT">
                    ...
                    \phpOMS\Model\Model::generate_table_header_view(
                        [
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[0]['ID'],
                             'sort' => 1, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Type'],
                             'sort' => 0, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Reference'],
                             'sort' => 0, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Consignee'],
                             'sort' => 0, ],
