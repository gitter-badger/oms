    ...
    <table class="t t-1 c27-1 c27" id="i27-1-1">
        ...
        <tr>
            <th colspan="6" class="lT">
                ...
                <h1><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Articles']; ?></h1>
            <th class="rT">
                    ...
                    \phpOMS\Model\Model::generate_table_header_view(
                        [
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[0]['ID'],
                             'sort' => 1, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Matchcode'],
                             'sort' => 0, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Name'],
                             'sort' => 0, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Description'],
                             'sort' => 0,
                             'full' => true, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Amount'],
                             'sort' => 0, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Stock'],
                             'sort' => 0, ],
                            ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang['Reporter']['Location'],
                             'sort' => 0, ],
                        ]
                    );
                    ?>
