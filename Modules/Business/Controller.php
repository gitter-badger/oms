    ...
    public function showContentBackendUnit($request, $response)
    {
        switch ($request->getPath(4)) {
            case 'list':
                ...
                $unitListView->addData('nav', $navigation->getNav());
            ...
            case 'create':
                ...
                $navigation = \Modules\Navigation\Models\Navigation::getInstance($request->getHash(), $this->app->dbPool);
                $unitCreateView->addData('nav', $navigation->getNav());
    ...
    public function showContentBackendDepartment($request, $response)
    {
        switch ($request->getPath(4)) {
            case 'list':
                ...
                $navigation = \Modules\Navigation\Models\Navigation::getInstance($request->getHash(), $this->app->dbPool);
                $departmentListView->addData('nav', $navigation->getNav());
            ...
            case 'create':
                ...
                $navigation = \Modules\Navigation\Models\Navigation::getInstance($request->getHash(), $this->app->dbPool);
                $departmentCreateView->addData('nav', $navigation->getNav());
