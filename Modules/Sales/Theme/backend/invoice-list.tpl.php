        ...
        \phpOMS\Model\Model::generate_table_header_view(
            [
                ...
                ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['Status'],
                 'sort' => 0, ],
                ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['ClientID'],
                 'sort' => 0, ],
                ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['ClientName'],
                 'sort' => 0, 'full' => true, ],
