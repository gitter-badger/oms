                ...
                \phpOMS\Model\Model::generate_table_header_view(
                    [
                        ...
                        ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['Name'],
                         'sort' => 0, 'full' => true, ],
                        ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['Available'],
                         'sort' => 0, ],
                        ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['Ordered'],
                         'sort' => 0, ],
                        ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['Class'],
                         'sort' => 0, ],
                        ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['Group'],
                         'sort' => 0, ],
                        ['name' => $this->app->accountManager->get($request->getAccount())->getL11n()->lang[16]['Subgroup'],
                         'sort' => 0, ],
                    ]
                );
                ?>
