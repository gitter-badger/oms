 ...
 * Header
 */
$headerView->setTitle($this->l11n->lang['RiskManagement']['Solutions']);
$headerView->setHeader([
    ['title' => $this->l11n->lang[0]['ID'], 'sortable' => true],
    ['title' => $this->l11n->lang['RiskManagement']['Status'], 'sortable' => true],
    ['title' => $this->l11n->lang['RiskManagement']['Name'], 'sortable' => true, 'full' => true],
    ['title' => $this->l11n->lang['RiskManagement']['Parent'], 'sortable' => true],
    ['title' => $this->l11n->lang['RiskManagement']['Risk'], 'sortable' => true],
    ['title' => $this->l11n->lang['RiskManagement']['Protection'], 'sortable' => true],
    ['title' => $this->l11n->lang['RiskManagement']['Probability'], 'sortable' => true],
    ['title' => $this->l11n->lang['RiskManagement']['Cost'], 'sortable' => true],
]);
