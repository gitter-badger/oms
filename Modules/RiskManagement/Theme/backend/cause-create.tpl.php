...
<div class="b b-2 c30-1 c30" id="i30-1-1">
    <h1>
        <?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang['RiskManagement']['Cause']; ?>
    ...
    <div class="bc-1">
        <ul class="l-1">
            ...
            <li><input type="text">
            <li><?= $this->app->accountManager->get($request->getAccount())->getL11n()->lang['RiskManagement']['Risk']; ?>
            <li><input type="text">
