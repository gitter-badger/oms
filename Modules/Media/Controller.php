...
class Controller extends \phpOMS\Module\ModuleAbstract implements \phpOMS\Module\WebInterface
{
    ...
    private function showContentBackend($request, $response)
    {
        switch ($request->getPath(3)) {
            ...
            case 'create':
                ...
                $navigation = \Modules\Navigation\Models\Navigation::getInstance($request->getHash(), $this->app->dbPool);
                $mediaCreate->addData('nav', $navigation->getNav());
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    private function createMedia($request, $response)
    {
        $upload  = new \Modules\Media\Models\UploadFile();
        ...
        // TODO: if array automatically jsonfy on render
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    private function createCollection($request, $response)
    {
    }
}
