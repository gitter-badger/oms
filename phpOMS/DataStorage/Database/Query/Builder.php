...
class Builder
{
     ...
     * Query type.
     *
     * @var \phpOMS\DataStorage\Database\Query\QueryType
     * @since 1.0.0
     */
    protected $type = null;
     ...
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
    public function __construct(\phpOMS\DataStorage\Database\Connection\ConnectionAbstract $connection)
    {
    ...
    public function groupBy($columns) : Builder
    {
        if (is_array($columns)) {
            $this->groups += $columns;
        } elseif (is_string($columns) || $columns instanceof \Closure) {
            $this->groups[] = $columns;
        } else {
            throw new \InvalidArgumentException();
        }
    ...
    public function startTransaction() : Builder
    {
     ...
     * Get query type.
     *
     * @return \phpOMS\DataStorage\Database\Query\QueryType
     *
     * @since  1.0.0
     * @author Dennis Eichhorn <d.eichhorn@oms.com>
     */
